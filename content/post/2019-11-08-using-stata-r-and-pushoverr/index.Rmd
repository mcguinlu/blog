...
I recently took over a project that made use of Stata to perform the analysis and subsequently used R<sup>`r (sn <- sn+1)`</sup> `r tufte::margin_note(paste0("<sup>",sn,"</sup>Pronounced \"oar\""))` to create plots of the results. 
