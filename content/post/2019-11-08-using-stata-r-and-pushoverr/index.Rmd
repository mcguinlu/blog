...
I recently took over a project that made use of Stata to perform the analysis and subsequently used R`r sidenote("Pronounced \"oar\"")` to create plots of the results. 
